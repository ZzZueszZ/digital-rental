    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-zinc-50 px-8 overflow-hidden relative">
      ...
      <div className="w-full max-w-xl bg-white border border-black/5 rounded-2xl p-10 flex flex-col items-center text-center space-y-8 shadow-dash-card relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center shadow-lg border-2 border-white">
        ...
        <div className="space-y-3">
          ...
          <p className="text-zinc-500 font-medium text-base max-w-sm mx-auto leading-relaxed">
            Kiểm tra hộp thư của bạn để hoàn tất quy trình kích hoạt tài khoản
            studio.
          </p>
        </div>
        ...
        <div className="w-full space-y-4 pt-4">
          <Button
            disabled={!canResend}
            className="w-full h-12 bg-red-600 text-white hover:bg-zinc-900 font-bold text-sm rounded-xl shadow-dash-card active:scale-[0.95] transition-all disabled:opacity-30 border-none"
          >
