    ...
    return (
      <div className="min-h-screen bg-white pt-24 px-6 container mx-auto flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-xs font-semibold text-zinc-400">Đang khởi tạo studio...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden sm:flex flex-col items-end">
              <span className="text-xs font-semibold text-zinc-400 leading-none mb-1">Thương hiệu</span>
              <span className="text-sm font-bold text-zinc-950 tracking-tight">{product.brand}</span>
            </div>
            <div className="w-px h-8 bg-zinc-100 hidden sm:block" />
            <div className="flex flex-col items-end">
              <span className="text-xs font-semibold text-zinc-400 leading-none mb-1">Danh mục</span>
              <span className="text-sm font-bold text-red-600 tracking-tight">{product.categoryName}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-10">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                {reviewMeta && (
                  <div className="flex items-center gap-1.5 text-zinc-950 text-xs font-semibold">
                    ...
                    <span className="text-zinc-400 font-medium ml-1">({reviewMeta.totalReviews} Đánh giá)</span>
                  </div>
                )}
              </div>
            ...
            <div className="pt-10 border-t border-zinc-100">
               <h4 className="text-xs font-bold text-zinc-400 mb-6 uppercase tracking-wider">Thông số kỹ thuật</h4>
               <div className="grid grid-cols-1 gap-3">
                 {product.specifications?.map((spec) => (
                   <div key={spec.id} className="flex items-center justify-between py-4 border-b border-zinc-50 group">
                     <span className="text-xs font-semibold text-zinc-400 group-hover:text-zinc-950 transition-colors">{spec.specKey}</span>
                     <span className="text-xs font-bold text-zinc-950">{spec.specValue}</span>
                   </div>
                 ))}
               </div>
            </div>
        ...
        <div className="mt-16 pt-12 border-t border-zinc-100">
          ...
          {reviews.length > 0 ? (
            ...
            <div className="py-24 text-center bg-zinc-50/50 rounded-[2rem] border-2 border-dashed border-zinc-100">
               ...
               <p className="text-xs font-semibold text-zinc-300">Chưa có đánh giá nào</p>
            </div>
          )}
        </div>
      </div>
