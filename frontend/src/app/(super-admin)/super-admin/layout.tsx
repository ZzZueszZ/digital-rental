...
export default function SuperAdminLayout({
  ...
  const allowedRoles = useMemo(() => [Role.SUPER_ADMIN], []);

  const pageTitle = useMemo(() => {
    if (pathname === "/super-admin")
      return { title: "Tổng quan", subtitle: "Điều phối toàn hệ thống" };
    if (pathname.includes("/roles"))
      return { title: "Vai trò", subtitle: "Quản lý nhóm quyền" };
    if (pathname.includes("/permissions"))
      return { title: "Quyền hạn", subtitle: "Quản lý quyền truy cập" };
