...
public final class E2eeRoutePolicy {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            sensitive(HttpMethod.GET, "/rentals/my"),
            sensitive(HttpMethod.GET, "/rentals/\\d+"),
            sensitive(HttpMethod.GET, "/rentals/\\d+/contract"),
            critical(HttpMethod.GET, "/rentals/staff"),
            critical(HttpMethod.GET, "/rentals/staff/\\d+"),
            ...
            sensitive(HttpMethod.GET, "/rentals/admin/products/\\d+/devices"),
            sensitive(HttpMethod.GET, "/rentals/admin/products/\\d+/devices/available"),
