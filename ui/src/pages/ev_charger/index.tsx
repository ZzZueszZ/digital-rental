...
import EvChargerContainer from '@/pages/ev_charger/components/container';
import styles from './styles.module.less';
import { latLng } from 'leaflet';
import {Marker} from "@/pages/ev_charger/data";
const ChargingStation = () => {
  ...
  const [stations, setStations] = useState<Marker[]>(markers);

  const addStation = (newStation: Marker) => {
    setStations([...stations, newStation]);
  };

  const updateStation = (stationId: string, updatedData: Marker) => {
    setStations(stations.map(station =>
      station.stationId === stationId ? { ...station, ...updatedData } : station
    ));
  };
  ...
  return (
    <PageContainer>
      <div className={styles.container}>
        <div className={styles.evChargerContainer}>
          <EvChargerContainer
            stations={stations}
            onAdd={addStation}
