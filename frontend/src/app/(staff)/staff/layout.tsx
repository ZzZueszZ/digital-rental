...
import { StaffSidebar } from "@/components/admin/sidebar";
...
export default function StaffLayout({
  ...
  const pageTitle = useMemo(() => {
    ...
    return { title: "LensHub", subtitle: "Staff Portal" };
  }, [pathname]);
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-zinc-900 text-white flex items-center justify-center font-semibold text-sm shadow-md shadow-zinc-200">
