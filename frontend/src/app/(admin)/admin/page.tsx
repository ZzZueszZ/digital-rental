    ...
    <div className="flex-1 space-y-6 lg:space-y-10">
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <Card
            key={i}
            className="rounded-2xl border-zinc-200 bg-white overflow-hidden group hover:shadow-xl shadow-sm transition-all duration-500 hover:-translate-y-1"
          >
          ...
          <CardContent className="p-4 sm:p-8">
            <div className="space-y-4 sm:space-y-5">
              {topProducts.map((p, i) => (
                <div
                  key={p.productId}
                  className="flex items-center justify-between group p-2 rounded-xl transition-all border border-transparent hover:border-zinc-100 hover:bg-zinc-50"
                >
                  <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl border border-zinc-200 overflow-hidden relative flex-shrink-0">
                      {p.imageUrl ? (
                        <Image
                    ...
                    <div className="min-w-0">
                      <p className="text-sm sm:text-md font-bold text-zinc-900 group-hover:text-red-600 transition-colors truncate">
                        {p.productName}
                      </p>
                  ...
                  <div className="text-right">
                    <div className="font-bold text-md sm:text-lg text-zinc-950">
                      {p.totalSold}
                    </div>
                  </div>
                </div>
          ...
          <CardContent className="p-4 sm:p-8">
            <div className="space-y-4">
              {lowStock.map((p) => (
                <div
                  key={p.productId}
                  className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-zinc-50 border border-zinc-100 hover:shadow-md transition-all"
                >
                  <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
                    <div className="w-12 h-12 rounded-xl border border-zinc-200 overflow-hidden flex-shrink-0 relative">
                      {p.imageUrl ? (
                        <Image
                          src={getImageUrl(p.imageUrl)}
                          alt={p.productName}
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="inline-flex mt-1 px-1.5 py-0.5 rounded-md bg-red-600 text-white text-[9px] font-bold">
                        Còn {p.stock}
                      </div>
                    </div>
                  </div>
