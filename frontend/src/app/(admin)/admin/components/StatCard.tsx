  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 bg-zinc-50 group-hover:scale-110", accent.replace("bg-", "text-"))}>
          <Icon className="w-5 h-5" strokeWidth={2} />
        </div>
      </div>

      <p className="text-[28px] font-bold tracking-tight text-zinc-950 mb-3">{value}</p>
