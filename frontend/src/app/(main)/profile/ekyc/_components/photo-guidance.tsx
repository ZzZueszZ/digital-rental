...
export function PhotoGuidance() {
  return (
    <aside className="rounded-2xl border border-zinc-200 bg-white p-5 lg:p-6">
      <h3 className="text-base font-semibold text-zinc-950">Hướng dẫn chụp ảnh</h3>
      <div className="mt-5 space-y-4">
        {GUIDANCE.map(([Icon, title, detail]) => (
          <div key={title} className="flex gap-3">
            <span className="flex size-9 shrink-0 items-center justify-center rounded-full border border-zinc-200">
