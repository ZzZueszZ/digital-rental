...
public interface InventoryService {
    ...
    InventoryAuditResponse updateSaleStock(Long productId, UpdateStockQuantityRequest request);
    InventoryAuditResponse updateRentalStock(Long productId, UpdateStockQuantityRequest request);
