        ...
        <div className="px-5 py-4 sm:py-5 border-b border-zinc-50">
          <div className="flex flex-col xl:flex-row justify-between xl:items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              ...
              <Button variant="outline" className="h-10 px-4 rounded-xl border-zinc-100 bg-zinc-50/50 text-[14px] font-bold text-zinc-600 gap-2">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-zinc-50/50 border-b border-zinc-100">
                  <th className="px-6 py-3.5 text-[13px] font-bold text-zinc-400">Đơn hàng</th>
                  <th className="px-6 py-3.5 text-[13px] font-bold text-zinc-400">Khách hàng</th>
                  <th className="px-6 py-3.5 text-[13px] font-bold text-zinc-400">Tổng thanh toán</th>
