      ...
      >
        <div className="flex h-20 items-center px-8 mb-2">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-xl bg-red-600 flex items-center justify-center shadow-lg shadow-red-600/20 group-hover:rotate-12 transition-transform duration-500">
              <div className="w-2 h-2 rounded-full bg-white animate-pulse" />
            </div>
            <span className="text-xl font-black tracking-tighter text-zinc-950">
              LENSHUB <span className="text-red-600 italic">PRO</span>
            </span>
          </Link>
        </div>
