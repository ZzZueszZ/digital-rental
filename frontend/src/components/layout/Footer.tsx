...
export function Footer() {
  return (
    <footer className="bg-white text-zinc-900 pt-10 pb-8 border-t border-zinc-200 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:col-span-3 lg:ml-auto w-full pt-4 lg:pt-0">
            ...
            <div className="space-y-6">
              <h4 className="text-[14px] font-semibold text-zinc-900 tracking-widest uppercase mb-6">Danh Mục</h4>
            ...
            {/* Column 2 */}
            <div className="space-y-6">
              <h4 className="text-[14px] font-semibold text-zinc-900 tracking-widest uppercase mb-6">Dịch Vụ</h4>
              <ul className="space-y-4">
            ...
            {/* Column 3 */}
            <div className="space-y-6">
              <h4 className="text-[14px] font-semibold text-zinc-900 tracking-widest uppercase mb-6">Hỗ Trợ</h4>
              <ul className="space-y-4">
