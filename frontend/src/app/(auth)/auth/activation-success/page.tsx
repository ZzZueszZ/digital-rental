    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-zinc-50 px-8 overflow-hidden relative">
      ...
      <div className="w-full max-w-xl bg-white border border-black/5 rounded-xl p-10 flex flex-col items-center text-center space-y-8 shadow-dash-card relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1 w-10 h-10 bg-white border border-black/5 rounded-xl flex items-center justify-center shadow-md">
        ...
        <div className="space-y-3">
          ...
          <p className="text-zinc-500 font-medium text-base max-w-sm mx-auto leading-relaxed">
            Tài khoản của bạn đã được xác thực thành công. Bạn đã sẵn sàng khám
            phá hệ sinh thái LensHub.
          </p>
        </div>
        ...
        <div className="w-full pt-4">
          <Link href={Routers.LOGIN} className="w-full">
            <Button className="w-full h-12 bg-zinc-900 text-white hover:bg-red-600 font-bold text-sm rounded-xl shadow-dash-card active:scale-[0.95] transition-all group border-none flex items-center justify-center gap-3">
              Bắt đầu ngay
