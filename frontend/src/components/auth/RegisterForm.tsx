  ...
  return (
    <div className='w-full max-w-md mx-auto lg:mx-0'>
      ...
      <div className='lg:hidden space-y-2 mb-8 text-center'>
        <h1 className='text-3xl md:text-4xl font-bold tracking-tight text-zinc-900'>Tạo tài khoản</h1>
        <p className='text-sm font-medium text-zinc-500'>Bắt đầu hành trình sáng tạo của bạn</p>
      </div>
      ...
      <form className='space-y-4' onSubmit={handleSubmit(onSubmit)}>
        <div className='space-y-2'>
          ...
          <Input
            ...
            {...register('fullName')}
            className={`h-12 bg-white border-black/5 rounded-lg focus-visible:ring-1 focus-visible:ring-red-600/30 focus-visible:border-red-600/30 caret-red-600 text-zinc-900 text-sm px-5 shadow-dash-card placeholder:text-zinc-400 ${errors.fullName ? 'border-red-500 ring-red-500' : ''}`}
          />
          {errors.fullName && (
        ...
        <div className='space-y-2'>
          <label className='text-sm font-bold text-zinc-900'>Xác nhận mật khẩu</label>
          <Input
            placeholder='Nhập lại mật khẩu'
            type='password'
            {...register('confirmPassword')}
            className={`h-12 bg-white border-black/5 rounded-lg focus-visible:ring-1 focus-visible:ring-red-600/30 focus-visible:border-red-600/30 caret-red-600 text-zinc-900 text-sm px-5 shadow-dash-card placeholder:text-zinc-400 ${errors.confirmPassword ? 'border-red-500 ring-red-500' : ''}`}
          />
        ...
        <Button
          className='w-full h-12 text-sm font-bold bg-zinc-900 text-white rounded-lg hover:bg-red-600 shadow-dash-card transition-all active:scale-95 mt-2'
          type='submit'
