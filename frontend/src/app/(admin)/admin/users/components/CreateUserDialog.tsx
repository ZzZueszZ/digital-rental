    ...
    >
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input
            ...
            className="h-10 rounded-xl bg-zinc-50/50 border border-zinc-950/5 focus:bg-white focus:border-red-600/30 font-semibold text-[15px] shadow-dash-card transition-all duration-200 ease-in-out focus:ring-4 focus:ring-red-600/5 outline-none focus-visible:ring-0 focus-visible:ring-transparent"
          />
        </div>
        <div>
          <label className="text-sm font-medium text-zinc-500 ml-1 mb-1.5 block">
      ...
      <div>
        ...
        <Input
          ...
          className={cn(
            "h-10 rounded-xl bg-zinc-50/50 border border-zinc-950/5 focus:bg-white focus:border-red-600/30 font-semibold text-[15px] shadow-dash-card transition-all duration-200 ease-in-out focus:ring-4 focus:ring-red-600/5 outline-none focus-visible:ring-0 focus-visible:ring-transparent",
      ...
      <div>
        ...
        <div className="relative">
          <Input
            ...
            className={cn(
              "h-10 rounded-xl bg-zinc-50/50 border border-zinc-950/5 focus:bg-white focus:border-red-600/30 font-semibold text-[15px] shadow-dash-card transition-all duration-200 ease-in-out focus:ring-4 focus:ring-red-600/5 pr-10 outline-none focus-visible:ring-0 focus-visible:ring-transparent",
